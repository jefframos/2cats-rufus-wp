...
{
    class FXGetStar : DefaultFX         
    {
        public FXGetStar(float x, float y)
            : base(x, y)
        {
        }
        public override void init(ContentManager Content)
        {
            texture = Content.Load<Texture2D>(".\\Sprites\\effects\\getStar\\FXStar");
            spriteSheetPositions = Content.Load<Dictionary<string, Rectangle>>(".\\Sprites\\effects\\getStar\\FXStarXML");
