...
{
    class MarioBehaviour : AbstractBehaviour
    {
        public MarioBehaviour()
        {
            tileSheet = ".\\Sprites\\rufus1\\rufusMario\\rufusMario";
            tileSheetXML = ".\\Sprites\\rufus1\\rufusMario\\rufusMarioXML";
